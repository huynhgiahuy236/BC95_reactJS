...
const Register = () => {
  return (
    <section className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-6 transition-colors duration-300">
          ...
          >
            <g fill="none" fillRule="evenodd">
              <g transform="translate(-702 -265)" fill="#FFF">
                <path d="M746 305h-9.725v-14.062c0-3.68-1.52-6.193-4.866-6.193-2.558 0-3.981 1.696-4.643 3.33-.248.586-.209 1.403-.209 2.22V305h-9.634s.124-24.909 0-27.173h9.634v4.265c.575-1.865 3.654-4.526 8.567-4.526 6.105 0 10.876 3.909 10.876 12.325V305zM707.179 274.428h-.062c-3.105 0-5.117-2.077-5.117-4.71 0-2.684 2.072-4.718 5.238-4.718 3.164 0 5.11 2.029 5.172 4.711 0 2.633-2.008 4.717-5.231 4.717zM703.11 277.827h8.576V305h-8.576v-27.173z" />
              </g>
            </g>
          </svg>
