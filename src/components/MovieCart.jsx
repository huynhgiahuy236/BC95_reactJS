  ...
  return (
    <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-yellow-400/20 hover:scale-105 transition-all duration-300 group">
      <div className="relative overflow-hidden">
        <img
          src={
            movie.hinhAnh || "https://via.placeholder.com/400x300?text=No+Image"
          }
      ...
      <div className="p-4">
        ...
        <Link
          ...
          className="block text-center bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-medium py-2 rounded-lg transition-colors"
        >
          Xem chi tiết
        </Link>
      </div>
